...
Attributes:
    ...
    first_name (str): The first name of the user. Optional, used only in database storage.
    last_name (str): The last name of the user. Optional, used only in database storage.
...
Conditional:
    ...
    - If `HBNB_TYPE_STORAGE` is not 'db', attributes are defined as plain strings.
"""
...
class User(BaseModel, Base):
    ...
    Represents a user in the system, including personal details and relationships
    with places and reviews.

    Attributes:
        email (str): The email address of the user. Required in database storage.
        password (str): The password of the user. Required in database storage.
        first_name (str): The first name of the user. Optional in database storage.
        last_name (str): The last name of the user. Optional in database storage.
        places (relationship): Relationship with `Place` objects, specifying how
                               `Place` objects are associated with this user.
        reviews (relationship): Relationship with `Review` objects, specifying how
    ...
    if getenv("HBNB_TYPE_STORAGE") == 'db':
        ...
        email = Column(String(128), nullable=False)  # User's email address
        password = Column(String(128), nullable=False)  # User's password
        first_name = Column(String(128), nullable=True)  # User's first name (optional)
        last_name = Column(String(128), nullable=True)  # User's last name (optional)
